...
public class NanumLotto extends JFrame {
	...
	NanumLotto() throws FontFormatException, IOException {
		...
		JLabel lblNewLabel_5 = new JLabel("보너스번호");
...
//				System.out.println("해당회차로 눌렀다");
		...
		button_1.addActionListener(
			(e)->{
				...
				if (cnt == 6) {
					lblNewLabel_1.setText("1등 당첨되었습니다.");
					JOptionPane.showMessageDialog(null, "1등 당첨되었습니다.", "당첨확인!", JOptionPane.PLAIN_MESSAGE);
				}
				else if (cnt == 5) {
					for (int i = 0; i < num.length; i++) {
					...
					if (cnt == 5 && temp == true) {
						lblNewLabel_1.setText("2등 당첨되었습니다.");
						JOptionPane.showMessageDialog(null, "2등 당첨되었습니다.", "당첨확인!", JOptionPane.PLAIN_MESSAGE);
					}
					else if (cnt == 5) {
						lblNewLabel_1.setText("3등 당첨되었습니다.");
						JOptionPane.showMessageDialog(null, "3등 당첨되었습니다.", "당첨확인!", JOptionPane.PLAIN_MESSAGE);
					}
				}
				else if (cnt == 4) {
					lblNewLabel_1.setText("4등 당첨되었습니다.");
					JOptionPane.showMessageDialog(null, "4등 당첨되었습니다.", "당첨확인!", JOptionPane.PLAIN_MESSAGE);
				}
				else if (cnt == 3) {
					lblNewLabel_1.setText("5등 당첨되었습니다.");
					JOptionPane.showMessageDialog(null, "5등 당첨되었습니다.", "당첨확인!", JOptionPane.PLAIN_MESSAGE);
				}
					
				else {
					lblNewLabel_1.setText("꽝입니다. 다음기회에...");
					JOptionPane.showMessageDialog(null, "꽝입니다.", "탕첨확인!", JOptionPane.PLAIN_MESSAGE);
				}
			}
		);
		this.repaint();
	...
	public void paint(Graphics g) {
		...
		g.drawString(number1, 50, 130); // 폰트의문자열, x, y좌표지정
